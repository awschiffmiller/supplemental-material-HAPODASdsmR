...
#    seg_tab <- table(micro_segs$segnum)
#    exp_tab <- structure(c(`1` = 2L, `2` = 14L, `3` = 15L, `4` = 15L, `5` = 7L,
...
#    segments_short <- segmentize(short_segs)
#    seg_tab <- table(short_segs$segnum)
#    exp_tab <- structure(c(`1` = 207L, `2` = 209L, `3` = 1456L, `4` = 206L,
